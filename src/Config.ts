...
export default class Config {
    ...
    constructor() {
        ...
        this._jwtAccessSecret = process.env.jwtAccessSecret || Generator.generateSequense(40);
        this._jwtRefreshSecret = process.env.jwtRefreshSecret || Generator.generateSequense(40);
        this.pg = {
    ...
    updateJwtSecrets() {
        this._jwtAccessSecret = Generator.generateSequense(40);
        this._jwtRefreshSecret = Generator.generateSequense(40);
        this.rewriteEnvFile();
    }
